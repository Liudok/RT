...
t_primitive			new_cylinder(cl_float3 origin, cl_float3 normal,
						float radius, float height);
t_primitive			new_cone(cl_float3 origin, cl_float3 normal, float m1,
						float m2);
t_primitive			new_disk(cl_float3 origin, cl_float3 normal, float radius);
t_primitive			new_cube(cl_float3 origin, cl_float3 min, cl_float3 max,
						int pipes_number);
