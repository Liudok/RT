...
void		get_primitives_details5(t_object *o, char *n, struct _json_value *val)
{
	...
	{
		o->prim.parabaloid.origin = !ft_strncmp(n, "origin", 6) ? get_float3(val) : o->prim.parabaloid.origin;
		o->prim.parabaloid.normal = !ft_strncmp(n, "normal", 6) ? get_float3(val) : o->prim.parabaloid.normal;
